...
const { client, isLoading, isError, clientMutation, updateClient, isUpdating, isUpdatingSuccess } =
...
//   //  const querys = queryClient.getQueryCache().findAll(['clients?page='], { exact: false });
//   //  querys.forEach((query) => query.fetch());
//   //
//   return data;
// };
...
<template>
  ...
  <div v-if="client">
    ...
    <form @submit.prevent="updateClient(client!)">
      <input type="text" placeholder="Nombre de cliente" v-model="client.name" />
      <br />
